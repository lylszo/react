...
import { getBorrowList, getValidCoinList } from '@/axios'
...
export default class extends Component {
  ...
  getList = (pageOrSearch) => {
    ...
    if (typeof pageOrSearch === 'object') { // 点击查询按钮
      let selectKeys = ['isBack', 'lendCoinId'] // 下拉选择的参数
    ...
    getBorrowList(params).then(data => {
      this.setState({
  ...
  render() {
    ...
    return (
      <div>
        <div className="pageTitle">借款记录</div>
